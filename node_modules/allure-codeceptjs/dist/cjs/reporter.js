...
class AllureCodeceptJsReporter extends _allureMocha.default {
  ...
  stepStarted(step) {
    ...
    while (current && !current.isBDD() && stepPath.length < MAX_META_STEP_NESTING) {
      ...
      stepPath.push((0, _sdk.stripAnsi)((_current$toString = current.toString()) !== null && _current$toString !== void 0 ? _current$toString : "").trim());
  ...
  stepFailed(_, error) {
    this.stopCurrentStep(result => {
      result.stage = _allureJsCommons.Stage.FINISHED;
      if (error) {
        result.status = (0, _sdk.getStatusFromError)({
          message: error.message
        });
